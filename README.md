...
For this assignment, I chose to look at the differences in prices between in-state students and out-of-state students for public and private schools in the US. I used the same dataset from our in-class tutorial but chose different sections because I thought that this would continue to be interesting and relevant to us, as Lehigh is a private school where I go as an out-of-state student.  Although the price does not change for private schools, I thought it would still be worthwhile to include in my maps so that readers can find that out for themselves. I decided to colorcode the prices instead of creating different sizes for each price because I thought it looked a little confusing and some colleges blocked others. I overall am happy with the color wavelength that I chose because it allows readers to be able to see everything. 
